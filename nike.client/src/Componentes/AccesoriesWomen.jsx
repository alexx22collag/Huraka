...
const AccesoriesWomen = () => {
    ...
    const baseUrl = "https://localhost:7218/api/Products/category/Women/subcategory/Accesories";
        ...
        <div className="slider" style={{ paddingTop: '150px' }}>
            ...
            <div className="slider__content" ref={sliderRef}>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/maternity.jpg" alt="Image" />
                    <div className="slider__info">
                        <h2>Maternity</h2>
                    </div>
                </div>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/snkW.jpg" alt="Image" />
                    <div className="slider__info">
                        <h2>Sneakers</h2>
                    </div>
                </div>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/TopsW.webp" alt="Image" />
                    <div className="slider__info">
                        <h2>Lifestyle</h2>
                    </div>
                </div>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/footballW.jpg" alt="Image" />
                    <div className="slider__info">
                        <h2>Football</h2>
                    </div>
                </div>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/skbW.jpeg" alt="Image" />
                    <div className="slider__info">
                        <h2>Skateboard</h2>
                    </div>
                </div>
                <div className="slider__item">
                    <img className="slider__image" src="./src/assets/bskW.jpeg" alt="Image" />
                    <div className="slider__info">
                        <h2>Basketball</h2>
                    </div>
                </div>
...
export default AccesoriesWomen;
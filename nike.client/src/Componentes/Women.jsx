                                    ...
                                    <div className="card-body px-0 text-center">
                                        ...
                                        <div className="d-flex justify-content-center align-items-center mx-auto mb-1 colspan-3 md-3">
                                            ...
                                            <div class="select-container">
                                                {/*<select className="custom-select" aria-label="Small select example" onChange={(e) => {*/}
                                                ...
                                                {/*</select>*/}
                                                <button className="btn btn-outline-danger btn-sm mx-2" onClick={() => handleDeleteProduct(product.id)}>Eliminar</button>w                                            </div>

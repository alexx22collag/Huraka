        ...
        <div className="postcard__text t-dark">
            ...
            <ul className="postcard__tagbox">
                <li className="tag__item">
                    <i className="fas fa-tag mr-2"></i>Today
                </li>
                <li className="tag__item">
                    <i className="fas fa-clock mr-2"></i>5 mins read.
                </li>
            </ul>
        </div>
    </article>
    ...
    <section className="light">
        <div className="container py-2">
            ...
            <PodcastCard
                ...
                description="For the first time ever, all 14 teams in the National Women's Soccer League (NWSL) will receive new, reimagined primary and secondary kits, featuring designs that convey each club's rich identity. Each team's primary kits express their unique stories through color and graphics while the secondary kits are inspired by the strength of the collective. The pre-match tops feature a shared design created by stacking traditional team crests on top of each other, adding textures and colors to symbolically unite the clubs.."
            />
            <PodcastCard
                color="red"
